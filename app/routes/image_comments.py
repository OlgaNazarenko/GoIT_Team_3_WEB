...
from .docs import comments as docs
...
@router.post("/", response_model=CommentPublic,
             ...
             description=docs.CREATE_COMMENT)
...
@router.get(
    ...
    description='No more than 10 requests per minute' + docs.CREATE_COMMENT,
...
@router.get("/{comment_id}", response_model=CommentPublic, description=docs.GET_COMMENT)
...
@router.put("/", response_model=CommentPublic,
            ...
            description=docs.UPDATE_COMMENT)
...
@router.delete('/{comment_id}', dependencies=[Depends(UserRoleFilter(UserRole.moderator))],
               description=docs.REMOVE_COMMENT)
